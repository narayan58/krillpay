       ...
       <form class="" method="POST" action="{{ route($link.'.update', $record->id) }}">
            ...
            <div class="row">
                ...
                <div class="form-group">
                    ...
                    <br>
                    <textarea id="my-editor" class="tinymce" name="scholarship_amount" placeholder="Place some text here" >{{ ($record->scholarship_amount) }}</textarea>
            ...
            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                ...
                <div class="form-group">
                    ...
                    <input type="date" class="form-control" id="valid_till" name="valid_till" value="{{ old('valid_till') ?? $record->valid_till }}" >
