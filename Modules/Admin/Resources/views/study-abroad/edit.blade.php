            ...
            <div class="row">
                <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="heading_title" name="heading_title" value="{{ old('heading_title') ?? $record->heading_title }}">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="tinymce" name="req_document_desc">{{ old('req_document_desc') ?? $record->req_document_desc }}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="tinymce" name="application_procedure_desc">{{ old('application_procedure_desc') ?? $record->application_procedure_desc }}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="tinymce" name="visa_procedure_fee_desc">{{ old('visa_procedure_fee_desc') ?? $record->visa_procedure_fee_desc }}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="title" name="meta_description"
                            value="{{ old('meta_description') ?? $record->meta_description }}">
                ...
                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                    <div class="form-group">
                        ...
                        <select name="country_id" id="country_id" class="form-control">
                            ...
                            <option value="{{ $item->id }}"
                                @if (old('country_id') ?? $record->country_id == $item->id)
                                    selected
                                @endif
                                >{{ $item->title }}</option>
                            @endforeach
                    ...
                    <div class="form-group">
                        ...
                        <button class="btn btn-warning prev_box_image" type="button" style="display: none;">Previous
                            Image</button>
                        <input type="hidden" value="{{ old('image') ?? asset($record->banner_image) }}" name="image" class="form-control" id="image">
                    </div>
                    <div class="form-group">
                        <label class="control-label">Banner Image <span class="text-danger">*</span></label>
                        @if(isset($record->banner_image) || old('banner_image') != null)
                        <img src="{{ old('image') ?? asset($record->banner_image) }}" alt="" title="" class='fancybox' id="prev_banner_img" />
                        @else
                        <img src="{{ asset('admin/images/no-image.png', $secure = null) }}" alt="" class='fancybox'
                            title="" id="prev_banner_img" />
                        @endif
                        ...
                        <button class="btn btn-warning prev_box_image" type="button" style="display: none;">Previous
                            Image</button>
                        <input type="hidden" value="{{ old('banner_image') ?? asset($record->banner_image) }}" name="banner_image" class="form-control" id="banner_image">
                    </div>
                    <div class="form-group">
