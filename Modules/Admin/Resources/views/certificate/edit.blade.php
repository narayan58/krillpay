                ...
                <form class="" method="POST" action="{{ route($link.'.update', $record->id) }}">
                    ...
                    <div class="form-group">
                        ...
                        <select name="certificate_type" id="certificate_type" class="form-control">
                            ...
                            <option value="1" @if((int)(old('certificate_type') ?? $record->certificate_type) == 1) selected @endif>Authorization Certificate</option>
                            <option value="2" @if((int)(old('certificate_type') ?? $record->certificate_type) == 2) selected @endif>Training Certificate</option>
                        </select>
                    </div>
